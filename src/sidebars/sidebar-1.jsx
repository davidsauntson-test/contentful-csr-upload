...
import {Box, Button, Paragraph, List, ListItem} from "@contentful/f36-components";
...
const Sidebar1 = () => {
    ...
    return (
        <Box>
            <Paragraph>Click 'Match suppliers' below to match the suppliers found in the spreadsheet with ones that are
